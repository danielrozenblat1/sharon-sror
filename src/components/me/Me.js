...
מאפרת מקצועית כבר למעלה מ-6 שנים, חיה ונושמת את תחום האיפור,בנוסף להיותי מאפרת כלות וערב העברתי סדנאות,הרצאות והשתלמויות  למאות מאפרות ואני בטוחה שיש לי לתת לך את כל הכלים שאת צריכה כדי להרים את העסק שלך למקום שאת רוצה שהוא יגיע , לחיזוק החלקים שאת פחות שולטת בהם ולקבלת ידע ששאר המאפרות מפחדות לחשוף!   
    ...
    <div className={styles.center}>
      ...
      <div className={styles.subtitle}>איך איך הגעתי לתחום האיפור אתן שאלות?</div>
      <div className={styles.content}>
      <p className={styles.explain}>
      הסיפור שלי מתחיל לפני כשנתיים, בתקופה מאתגרת בחיי. לאחר שנרשמתי ללימודי תואר שני בניהול מערכות ציבור וחוויתי קשיים, נאלצתי לבטל את הלימודים ולחשב מסלול מחדש. במהלך אותה תקופה, עברתי תהליך פנימי של חיפוש עצמי וגיבוש הייעוד שלי. התמודדתי עם הפער בין הרצון הפנימי לבין הציפיות של החברה והסביבה. לאחר תקופה של התחזקות באמונה, הגעתי להחלטה ללמוד איפור - התחום שבאמת רציתי. נרשמתי ללימודי איפור, ותוך חצי שנה סיימתי בהצטיינות. התחלתי לעבוד כשכירה במקביל להתפתחות כעצמאית, ותוך מספר חודשים הפכתי לעצמאית מצליחה. לאחר 5 שנים בתחום האיפור והשתלמויות רבות, החלטתי לחשוף את הידע שלי ולתת לאחרות את הכלים להצליח בתחום.   
        </p>
</div>
