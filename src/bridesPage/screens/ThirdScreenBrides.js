...
return <>
   ...
   <FAQItem question="האם ניתן להגיע להתאגן אצלך?" answer="כמובן! הסטודיו שלי נמצא בעכו ומתאים להתארגנות של כלה ו4 מלוות איתה, בסטודיו יש עמדת שיער למסרק/ת ,עמדת איפור,עמדת קפה וישיבה וכמובן - אווירה טובה  "/>
